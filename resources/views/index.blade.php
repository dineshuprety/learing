    ...
    <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
        ...
        <main aria-label="Main" class="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:py-12 lg:px-16 xl:col-span-6">
            <div class="max-w-xl lg:max-w-3xl">
                ...
                <form action="{{route('store')}}" class="mt-8 grid grid-cols-6 gap-6" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="col-span-6">
                        ...
                        <input type="text" id="FirstName" name="name" class="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm" />
                    </div>
                    ...
                    <div class="col-span-6">
                        ...
                        <select name="class" class="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm">
